  ...
  const routes = createBrowserRouter(
    createRoutesFromElements(
      <>
        ...
        {/* RUTAS DE ADMIN (SOLO SI loggedInUser.isAdmin === true) */}
        {loggedInUser?.isAdmin && (
          <>
            ...
            {/* CUALQUIER OTRA RUTA /admin/... REDIRIGE AL DASHBOARD */}
            <Route
              path='/admin/*'
        ...
        {/* RUTAS PROTEGIDAS PARA USUARIO (CUANDO NO ES ADMIN) */}
        {!loggedInUser?.isAdmin && (
          <>
            <Route
              path='/cart'
